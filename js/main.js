(() => {
  "use strict";
  if (document.querySelector(".overlay"), document.querySelector(".js-menu-close"), document.querySelector(".nav"), document.getElementById("top-rating")) {
      const e = document.querySelector(".top-rating__more");
      e.addEventListener("click", (function() {
          let t = document.querySelectorAll(".card-hidden");
          if (4 <= t.length)
              for (let e = 0; e < 4; e++) t[e].classList.remove("card-hidden"), t[e].style.display = "flex";
          else e.textContent = "В каталог!", e.addEventListener("click", (() => {
      ...
      for (let n = 1; n < e.length; n += 1) {
          ...
          if (null != a && (i = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
              ...
              for (let s = 0, i = e.length; s < i; s += 1) {
                  ...
                  void 0 !== n && n.enumerable && (g(t[i]) && g(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : v(t[i], a[i]) : !g(t[i]) && g(a[i]) ? (t[i] = {}, a[i].__swiper__ ? t[i] = a[i] : v(t[i], a[i])) : t[i] = a[i])
              }
          }
      }
      var i;
      ...
      x = {
          ...
          updateSlides: function() {
              ...
              let C = i.spaceBetween,
                  ...
                  S = 0;
              if (void 0 === a) return;
              "string" == typeof C && C.indexOf("%") >= 0 && (C = parseFloat(C.replace("%", "")) / 100 * a), e.virtualSize = -C, r ? c.css({
                  marginLeft: "",
                  marginBottom: "",
                  marginTop: ""
              }) : c.css({
              ...
              for (let n = 0; n < p; n += 1) {
                  ...
                  if (E && e.grid.updateSlide(n, r, p, t), "none" !== r.css("display")) {
                      ...
                      } else x = (a - (i.slidesPerView - 1) * C) / i.slidesPerView, i.roundLengths && (x = Math.floor(x)), c[n] && (c[n].style[t("width")] = `${x}px`);
                      c[n] && (c[n].swiperSlideSize = x), f.push(x), i.centeredSlides ? (y = y + x / 2 + T / 2 + C, 0 === T && 0 !== n && (y = y - a / 2 - C), 0 === n && (y = y - a / 2 - C), Math.abs(y) < .001 && (y = 0), i.roundLengths && (y = Math.floor(y)), S % i.slidesPerGroup == 0 && u.push(y), h.push(y)) : (i.roundLengths && (y = Math.floor(y)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), y = y + x + C), e.virtualSize += x + C, T = x, S += 1
                  }
              }
          ...
          updateAutoHeight: function(e) {
              ...
              if ("auto" !== t.params.slidesPerView && t.params.slidesPerView > 1)
                  if (t.params.centeredSlides)(t.visibleSlides || h([])).each((e => {
                      s.push(e)
                  }));
                  else
  ...
  const M = {
      ...
      slideToClickedSlide: function() {
          ...
          if (t.loop) {
              ...
              n = parseInt(h(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? a < e.loopedSlides - i / 2 || a > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), f((() => {
                  e.slideTo(a)
  ...
  function $(e) {
      ...
      if (Object.assign(r, {
              ...
              isScrolling: void 0,
              startMoving: void 0
          }), o.startX = b, o.startY = w, r.touchStartTime = m(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== c.type) {
          let e = !0;
          p.is(r.focusableElements) && (e = !1, "SELECT" === p[0].nodeName && (r.isTouched = !1)), s.activeElement && h(s.activeElement).is(r.focusableElements) && s.activeElement !== p[0] && s.activeElement.blur();
  ...
  function P(e) {
      ...
      if (!s.allowTouchMove) return h(d.target).is(n.focusableElements) || (s.allowClick = !1), void(n.isTouched && (Object.assign(r, {
          startX: p,
          startY: u,
          currentX: p,
          currentY: u
      ...
      if (void 0 === n.isScrolling) {
          let e;
          s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? n.isScrolling = !1 : f * f + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(f)) / Math.PI, n.isScrolling = s.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle)
      }
      if (n.isScrolling && s.emit("touchMoveOpposite", d), void 0 === n.startMoving && (r.currentX === r.startX && r.currentY === r.startY || (n.startMoving = !0)), n.isScrolling) return void(n.isTouched = !1);
      ...
      a.followFinger && !a.cssMode && ((a.freeMode && a.freeMode.enabled && s.freeMode || a.watchSlidesProgress) && (s.updateActiveIndex(), s.updateSlidesClasses()), s.params.freeMode && a.freeMode.enabled && s.freeMode && s.freeMode.onTouchMove(), s.updateProgress(n.currentTranslate), s.setTranslate(n.currentTranslate))
  }
  ...
  function L(e) {
      ...
      if (c > i.longSwipesMs) {
          ...
          "next" === t.swipeDirection && (b >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? g : u + w) : t.slideTo(u)), "prev" === t.swipeDirection && (b > 1 - i.longSwipesRatio ? t.slideTo(u + w) : null !== v && b < 0 && Math.abs(b) > i.longSwipesRatio ? t.slideTo(v) : t.slideTo(u))
      } else {
          if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
          !t.navigation || o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : u + w), "prev" === t.swipeDirection && t.slideTo(null !== v ? v : u)) : o.target === t.navigation.nextEl ? t.slideTo(u + w) : t.slideTo(u)
      }
  }
  ...
  const G = (e, t) => {
          const s = i(),
              ...
              u = t;
          if (d.touch) {
              const t = !("touchstart" !== a.start || !d.passiveListener || !n.passiveListeners) && {
                  passive: !0,
                  capture: !1
              };
          ...
          (n.preventClicks || n.preventClicksPropagation) && r[p]("click", e.onClick, !0), n.cssMode && l[p]("scroll", e.onScroll), n.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", O, !0) : e[u]("observerUpdate", O, !0)
      },
      B = {
          attachEvents: function() {
              ...
              e.onTouchStart = $.bind(e), e.onTouchMove = P.bind(e), e.onTouchEnd = L.bind(e), s.cssMode && (e.onScroll = I.bind(e)), e.onClick = A.bind(e), n.touch && !z && (t.addEventListener("touchstart", D), z = !0), G(e, "on")
          },
  ...
  const F = {
          ...
          transition: {
              ...
              transitionStart: function(e = !0, t) {
                  ...
                  i.cssMode || (i.autoHeight && s.updateAutoHeight(), k({
                      swiper: s,
                      runCallbacks: e,
                      direction: t,
                      step: "Start"
              ...
              transitionEnd: function(e = !0, t) {
                  ...
                  s.animating = !1, i.cssMode || (s.setTransition(0), k({
                      swiper: s,
                      runCallbacks: e,
                      direction: t,
                      step: "End"
          ...
          loop: {
              loopCreate: function() {
                  ...
                  for (let e = 0; e < o.length; e += 1) a.append(h(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
  ...
  class q {
      constructor(...e) {
          let t, s;
          if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = v({}, s), t && !s.el && (s.el = t), s.el && h(s.el).length > 1) {
              const e = [];
          ...
          const i = this;
          i.__swiper__ = !0, i.support = S(), i.device = function(e = {}) {
              return y || (y = function({
                  userAgent: e
              } = {}) {
                  const t = S(),
          ...
          }()), T), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
          const n = {};
          i.modules.forEach((e => {
              e({
                  swiper: i,
          ...
          const r = v({}, j, n);
          return i.params = v({}, r, V, s), i.originalParams = v({}, i.params), i.passedParams = v({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
      ...
      mount(e) {
          ...
          if (0 === a.length && t.params.createElements) {
              ...
              a = h(e), e.className = t.params.wrapperClass, s.append(e), s.children(`.${t.params.slideClass}`).each((e => {
                  a.append(e)
              }))
          }
  ...
  Object.keys(F).forEach((e => {
      ...
      t("init", (() => {
          ...
          })), n.observe(e.el)) : (i.addEventListener("resize", l), i.addEventListener("orientationchange", o))
      })), t("destroy", (() => {
          r && i.cancelAnimationFrame(r), n && n.unobserve && e.el && (n.unobserve(e.el), n = null), i.removeEventListener("resize", l), i.removeEventListener("orientationchange", o)
      }))
  }, function({
      swiper: e,
      extendParams: t,
  ...
  function R(e, t, s, n) {
      ...
      return e.params.createElements && Object.keys(n).forEach((i => {
          if (!s[i] && !0 === s.auto) {
              ...
              r || (r = a.createElement("div"), r.className = n[i], e.$el.append(r)), s[i] = r, t[i] = r
          }
      })), s
  }
  ...
  function U({
      ...
      function d() {
          ...
          if ("fraction" === s.type && (d.find(Y(s.currentClass)).text(s.formatFractionCurrent(c + 1)), d.find(Y(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
              let t;
              t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
              const i = (c + 1) / p;
              let n = 1,
                  a = 1;
              "horizontal" === t ? n = i : a = i, d.find(Y(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(e.params.speed)
          }
      ...
      function u() {
          ...
          s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(e.isHorizontal() ? t.horizontalClass : t.verticalClass), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", Y(t.bulletClass))
      }
      s("init", (() => {
          ...
          if (e.params.pagination.el && e.params.pagination.hideOnClick && a && a.length > 0 && !h(n).hasClass(e.params.pagination.bulletClass)) {
  ...
  function Q({
      ...
      function r() {
          ...
          t.attr("data-swiper-autoplay") && (s = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(a), a = f((() => {
              let t;
      ...
      e.autoplay = {
          ...
          e.params.autoplay.enabled && (l(), i().addEventListener("visibilitychange", c), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", u), e.$el.on("mouseleave", h)))
          ...
          e.$el.off("mouseenter", u), e.$el.off("mouseleave", h), e.autoplay.running && o(), i().removeEventListener("visibilitychange", c)
  ...
  window.addEventListener("load", (function(e) {
      document.querySelector(".participants-slider") && new W(".participants-slider", {
          modules: [U, X, Q],
          observer: !0,
          observeParents: !0,
          slidesPerView: 3,
          ...
          loop: !0,
          pagination: {
              el: ".section-participants .swiper-pagination-participants",
              type: "fraction"
          },
          navigation: {
              nextEl: ".swiper-button-next-participants",
              prevEl: ".swiper-button-prev-participants"
          },
          breakpoints: {
              375: {
                  slidesPerView: 1,
      ...
      ((e, t, s, i) => {
          let n;
          const a = function() {
              return e.matches ? (n = new W(".slider-stages", s), void(i && i(n))) : void(void 0 !== n && n.destroy(!0, !0))
          };
          (e = window.matchMedia(e)).addEventListener("change", a), a()
      })("(max-width: 768px)", 0, {
          spaceBetween: 32,
          slidesPerView: 1,
          slidesPerGroup: 1,
  ...
  setTimeout((() => {
      ...
      }, K.prototype.mediaHandler = function(e, t) {
          if (e.matches)
      ...
      }, K.prototype.moveTo = function(e, t, s) {
      ...
      }, K.prototype.moveBack = function(e, t, s) {
      ...
      }, K.prototype.indexInParent = function(e, t) {
          const s = Array.prototype.slice.call(e.children);
          return Array.prototype.indexOf.call(s, t)
      }, K.prototype.arraySort = function(e) {
